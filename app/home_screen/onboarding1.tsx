...
export default function FaqClient1() {
  ...
  const handlePress = () => {
    router.replace("/home_screen/onboarding2"); 
  };
  ...
  return (
    <Pressable style={{ flex: 1 }} onPress={handlePress}>
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "white" }}>
        <Image
          source={require("../../assets/images/scoll.png")}
          style={{ width: 300, height: 400, resizeMode: "contain" }}
        />
        <Text style={{ marginTop: 8, fontSize: 18, textAlign: "center", color: "black", padding: 20 }}>
          Parourez des vêtements sur mesure et prêt a porter selon votre goût
        </Text>
        <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", marginTop: 40 }}>
          <View style={{ width: 12, height: 12, borderRadius: 6, backgroundColor: "black", opacity: 0.8 }} />
